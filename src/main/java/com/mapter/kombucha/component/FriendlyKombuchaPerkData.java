...
public record FriendlyKombuchaPerkData(int increasedJumpLevel, int fallImmunityLevel) {
    public static final FriendlyKombuchaPerkData DEFAULT = new FriendlyKombuchaPerkData(0, 0);
