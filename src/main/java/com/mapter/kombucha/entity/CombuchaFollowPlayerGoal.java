...
public class CombuchaFollowPlayerGoal extends Goal {
    ...
    public CombuchaFollowPlayerGoal(Monster mob, double speedModifier, double startDistance, double stopDistance) {
        this.mob = mob;
    ...
    public boolean canUse() {
        ...
        TargetingConditions conditions = TargetingConditions.forNonCombat()
                ...
                .ignoreLineOfSight()
                .selector((entity, ignored) -> CombuchaRelations.isIdolOfCombuchas(entity));
    ...
    public boolean canContinueToUse() {
        return this.target != null
                && this.target.isAlive()
                && CombuchaRelations.isIdolOfCombuchas(this.target)
