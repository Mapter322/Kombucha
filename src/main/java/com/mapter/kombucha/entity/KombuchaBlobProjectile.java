...
public abstract class KombuchaBlobProjectile extends ThrowableItemProjectile {
    protected KombuchaBlobProjectile(EntityType<? extends KombuchaBlobProjectile> type, Level level) {
        super(type, level);
    }

    protected KombuchaBlobProjectile(EntityType<? extends KombuchaBlobProjectile> type, LivingEntity owner, Level level, Item item) {
