...
public class SpoiledKombuchaMonster extends Monster implements RangedAttackMob {
    private static final EntityDataAccessor<Integer> SHOOT_TIME =
            SynchedEntityData.defineId(SpoiledKombuchaMonster.class, EntityDataSerializers.INT);
    private double rangedTargetX;
    private double rangedTargetY;
    private double rangedTargetZ;
    private float rangedPower;

    public SpoiledKombuchaMonster(EntityType<? extends SpoiledKombuchaMonster> type, Level level) {
        super(type, level);
    }
