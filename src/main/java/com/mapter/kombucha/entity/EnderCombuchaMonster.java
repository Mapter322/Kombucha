...
public class EnderCombuchaMonster extends Monster implements net.minecraft.world.entity.monster.RangedAttackMob {
    private static final EntityDataAccessor<Integer> SHOOT_TIME =
            SynchedEntityData.defineId(EnderCombuchaMonster.class, EntityDataSerializers.INT);
    private double rangedTargetX;
    private double rangedTargetY;
    private double rangedTargetZ;
    private float rangedPower;

    public EnderCombuchaMonster(EntityType<? extends EnderCombuchaMonster> type, Level level) {
        super(type, level);
    }
