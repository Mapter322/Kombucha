...
public class CaveKombuchaMonsterModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create()
                .texOffs(0, 16).addBox(-4.5F, -1.0F, 1.0F, 14.0F, 2.0F, 14.0F, new CubeDeformation(0.0F))
                .texOffs(0, 46).addBox(-3.5F, -3.0F, 2.0F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(56, 0).addBox(-2.5F, -5.0F, 3.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
                ,
                PartPose.offset(-2.5F, 12.0F, -8.0F));

        head.addOrReplaceChild("eyes", CubeListBuilder.create()
                .texOffs(64, 28).addBox(-1.5F, -6.0F, 4.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(56, 28).addBox(4.5F, -6.0F, 4.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.ZERO);

        head.addOrReplaceChild("cube_r1", CubeListBuilder.create()
                .texOffs(72, 29).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-2.5F, 8.0F, 15.0F, -1.5708F, 0.0F, 0.0F));
        head.addOrReplaceChild("cube_r2", CubeListBuilder.create()
                .texOffs(72, 23).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(6.5F, -5.0F, 13.0F, -1.5708F, 0.0F, 0.0F));
        head.addOrReplaceChild("cube_r3", CubeListBuilder.create()
                .texOffs(72, 26).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(7.5F, 5.0F, 2.0F, 1.5708F, 0.0F, -3.1416F));
        head.addOrReplaceChild("cube_r4", CubeListBuilder.create()
                .texOffs(72, 20).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(-3.5F, 3.0F, 12.0F, 0.0F, -1.5708F, -1.5708F));

        PartDefinition mouthTentacles = head.addOrReplaceChild("mouth_tentacles", CubeListBuilder.create()
                .texOffs(72, 72).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(48, 75).addBox(1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(54, 75).addBox(3.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(60, 75).addBox(5.0F, -1.0F, -0.75F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));
        mouthTentacles.addOrReplaceChild("cube_r5", CubeListBuilder.create()
                .texOffs(60, 72).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(54, 72).addBox(1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(66, 72).addBox(-3.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
        ...
        mouthTentacles.addOrReplaceChild("cube_r6", CubeListBuilder.create()
                .texOffs(48, 72).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
    ...
    private static void addTentacle(PartDefinition root, String name, int firstU, int firstV,
        ...
        PartDefinition tentacle = root.addOrReplaceChild(name, CubeListBuilder.create()
                .texOffs(firstU, firstV).addBox(-0.5412F, -2.0F, -6.3338F, 2.0F, 2.0F, 6.0F,
                        new CubeDeformation(0.0F)), PartPose.offsetAndRotation(x, y, z, xRot, yRot, zRot));
        tentacle.addOrReplaceChild("segment_a", CubeListBuilder.create()
                .texOffs(secondU, secondV).addBox(-1.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F,
                        new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4588F, -3.75F, -12.3338F, -1.0036F, 0.0F, 0.0F));
        tentacle.addOrReplaceChild("segment_b", CubeListBuilder.create()
                .texOffs(thirdU, thirdV).addBox(-1.0F, -2.0F, -5.0F, 2.0F, 2.0F, 6.0F,
                        new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4588F, -0.5F, -7.3338F, -0.48F, 0.0F, 0.0F));
    }
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        this.head.y += Mth.sin(idle) * 1.0F - 1.0F;
        ...
        if (state instanceof CombuchaMonsterRenderState combuchaState) {
            ...
            if (combuchaState.shootTime > 0) {
                float shoot = (8.0F - combuchaState.shootTime) / 8.0F;
                this.mouthTentacles.xRot -= Mth.sin(shoot * Mth.PI) * 0.6F;
            }
