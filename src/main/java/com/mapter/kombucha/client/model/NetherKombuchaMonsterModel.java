...
public class NetherKombuchaMonsterModel extends EntityModel<LivingEntityRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(Kombucha.MODID, "nether_kombucha_monster"), "main");
    ...
    public NetherKombuchaMonsterModel(ModelPart root) {
        super(root);
        ...
        this.idleAnimation = nether_kombucha_monsterAnimation.idle.bake(root);
        this.attackAnimation = nether_kombucha_monsterAnimation.attack.bake(root);
        this.shootAnimation = nether_kombucha_monsterAnimation.shoot.bake(root);
        this.walkAnimation = nether_kombucha_monsterAnimation.walk.bake(root);
    }
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        if (state instanceof KombuchaMonsterRenderState kombuchaState && kombuchaState.attackTime > 0.0F) {
            this.attackAnimation.apply((long) (kombuchaState.attackTime * 800.0F), 1.5F);
        }
