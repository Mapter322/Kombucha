...
public class EnderKombuchaMonsterModel extends EntityModel<LivingEntityRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(Kombucha.MODID, "ender_kombucha_monster"), "main");
    ...
    public EnderKombuchaMonsterModel(ModelPart root) {
        super(root);
        ...
        this.idleAnimation = ender_kombucha_monsterAnimation.idle.bake(root);
        this.attackAnimation = ender_kombucha_monsterAnimation.attack.bake(root);
        this.shootAnimation = ender_kombucha_monsterAnimation.shoot.bake(root);
        this.walkAnimation = ender_kombucha_monsterAnimation.walk.bake(root);
    }
